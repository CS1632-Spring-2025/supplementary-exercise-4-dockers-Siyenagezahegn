...
public class D3Test {
    ...
    public void tEST2RESET() {
        ...
        {
            List<WebElement> elements = driver.findElements(By.xpath("//li[contains(text(), \'ID 1. Jennyanydots\')]"));
            assert (elements.size() > 0);
        }
        {
            List<WebElement> elements = driver.findElements(By.xpath("//li[contains(text(), \'ID 2. Old Deuteronomy\')]"));
            assert (elements.size() > 0);
        }
        {
            List<WebElement> elements = driver.findElements(By.xpath("//li[contains(text(), \'ID 3. Mistoffelees\')]"));
            assert (elements.size() > 0);
        }
    }
